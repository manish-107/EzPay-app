            ...
            <div className='flex items-center justify-center p-3 border border-gray-300 rounded'>
                ...
                <div className="w-full max-w-sm p-10 bg-white border border-gray-200 rounded-lg shadow h-fit dark:bg-gray-800 dark:border-gray-700">
                    <div className="flex flex-col items-center p-10">
                        ...
                        ] border-white rounded-full shadow-lg "  >A</div>
                        ...
                        <input type="number" min="0" className="block w-full p-2 mt-3 text-sm font-bold text-gray-900 border border-gray-300 rounded-lg ps-10 bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
